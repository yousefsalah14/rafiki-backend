...
router.post(
  '/professor_signup',
  validator.addProfessor,
  usersController.addProfessor,
);
...
router.post(
  '/check_national_id',
  validator.checkNationalIdExists,
  usersController.checkNationalIdExists,
);

router.post(
  '/check_email',
  validator.checkEmailExists,
  usersController.checkEmailExists,
);
...
router.post(
  '/check_academic_id',
  validator.checkAcademicIdExists,
  usersController.checkAcademicIdExists,
);
...
router.post(
  '/upload_picture',
  isAuthorized,
  validator.uploadProfilePicture,
...
router.put(
  '/update_about',
  isAuthorized,
  validator.updateAbout,
  usersController.updateAbout,
);
...
router.put(
  ...
  usersController.updateCountry,
);

router.put(
  '/update_social_urls',
  isAuthorized,
  validator.updateSocialUrls,
  usersController.updateSocialUrls,
);
...
router.get(
  '/generate_cv',
  isAuthorized,
  validator.generateCV,
  genCvLimit,
  usersController.generateCV,
);
...
router.delete(
  '/delete_behance_url',
  isAuthorized,
  usersController.deleteBehanceUrl,
);

router.delete(
  '/delete_github_url',
  isAuthorized,
  usersController.deleteGitHubUrl,
);

router.delete(
  '/delete_linkedin_url',
  isAuthorized,
  usersController.deleteLinkedInUrl,
);

...
exports.isLoggedIn = (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .send({ success: true, message: 'User is logged in.', actor });
  } catch (err) {
    next(err);
  }
};

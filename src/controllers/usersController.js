...
exports.addAlumni = async (req, res, next) => {
  try {
    ...
    if (
      (await user_util.checkEmailExists(Email)) ||
      (await user_util.checkNationalIdExists(National_Id)) ||
      (await user_util.checkUserNameExists(UserName))
    ) {
      res
        .status(400)
        .send({
          success: false,
          message: 'Email or National Id or User Name already exists.',
        });
      return;
    }
    ...
    res
      .status(201)
      .send({ success: true, message: 'Alumni added successfully.' });
  } catch (err) {
    next(err);
  }
};
...
exports.addProfessor = async (req, res, next) => {
  try {
    ...
    res
      .status(201)
      .send({ success: true, message: 'Professor added successfully.' });
  } catch (err) {
    next(err);
  }
};
  ...
  try {
    ...
    if (exists) {
      res
        ...
        .send({
          success: false,
          message: 'National Id exists please try another one..',
        });
    } else {
      res
        .status(404)
        .send({ success: true, message: 'National Id does not exist.' });
    }
  } catch (err) {
    next(err);
  }
...
exports.checkUserNameExists = async (req, res, next) => {
  try {
    ...
    if (exists) {
      ...
      res
        .status(404)
        .send({ success: true, message: 'User Name does not exist.' });
    }
  } catch (err) {
    next(err);
  }
  ...
  try {
    ...
    if (exists) {
      res
        ...
        .send({
          success: false,
          message: 'Academic Id exists please try another one..',
        });
    } else {
      res
        .status(200)
        .send({ success: true, message: 'Academic Id does not exist.' });
    }
  } catch (err) {
    next(err);
  }
...
exports.updatePhone = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .send({ success: true, message: 'Phone updated successfully.' });
  } catch (err) {
...
exports.uploadProfilePicture = async (req, res, next) => {
  try {
    ...
    if (user.Img) {
      const public_id =
        'images/' + user.Img.split('/').slice(-1)[0].split('.')[0];
...
exports.uploadCV = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .send({ success: true, message: 'CV uploaded successfully.', CV: cvUrl })
      .end();
  } catch (err) {
    next(err);
  }
...
exports.updateAbout = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .send({ success: true, message: 'About updated successfully.' });
  } catch (err) {
    next(err);
  }
};
...
exports.updateCountry = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .send({ success: true, message: 'Country updated successfully.' });
  } catch (err) {
    next(err);
  }
};
...
exports.updateSocialUrls = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .send({ success: true, message: 'Social URLs updated successfully.' });
  } catch (err) {
    next(err);
  }
};
...
exports.updatePosition = async (req, res, next) => {
  try {
    ...
    await user_util.updateJobTitle(User_Id, Job_Title);
    res
      .status(200)
      .send({ success: true, message: 'Job Title updated successfully.' });
  } catch (err) {
    next(err);
  }
};
...
exports.generateCV = async (req, res, next) => {
  try {
    ...
    if (missing.length > 0) {
      res
        .status(400)
        .send({ success: false, message: 'Missing credentials.', missing });
      return;
    }
    cvGenerator(data)
      .then(async (cv) => {
...
exports.deleteCV = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .send({ success: true, message: 'CV deleted successfully.' });
  } catch (err) {
    next(err);
  }
};
...
exports.deleteBehanceUrl = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .send({ success: true, message: 'Behance URL deleted successfully.' });
  } catch (err) {
    next(err);
  }
};
...
exports.deleteGitHubUrl = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .send({ success: true, message: 'GitHub URL deleted successfully.' });
  } catch (err) {
    next(err);
  }
};
...
exports.deleteLinkedInUrl = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .send({ success: true, message: 'LinkedIn URL deleted successfully.' });
  } catch (err) {
    next(err);
  }
};
...
exports.deleteAbout = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .send({ success: true, message: 'About deleted successfully.' });
  } catch (err) {
    next(err);
  }
};
...
exports.deletePhone = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .send({ success: true, message: 'Phone deleted successfully.' });
  } catch (err) {
    next(err);
  }
};

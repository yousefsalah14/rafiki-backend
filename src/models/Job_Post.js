...
Job_Post.belongsTo(Job_Category, { foreignKey: 'Job_Category_Id', onDelete: 'CASCADE', onUpdate: 'CASCADE' });
Job_Category.hasMany(Job_Post, { foreignKey: 'Job_Category_Id', onDelete: 'CASCADE', onUpdate: 'CASCADE' });
Job_Post.belongsTo(User, { foreignKey: 'Publisher_Id', onDelete: 'CASCADE', onUpdate: 'CASCADE' });
User.hasMany(Job_Post, { foreignKey: 'Publisher_Id', onDelete: 'CASCADE', onUpdate: 'CASCADE' });
